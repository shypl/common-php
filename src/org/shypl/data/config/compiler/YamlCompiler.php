<?php
namespace org\shypl\data\config\compiler;

use org\shypl\cache\link\FileListCacheLink;
use org\shypl\util\ArrayUtils;
use org\shypl\yaml\Yaml;

class YamlCompiler
{
	/**
	 * @param \org\shypl\cache\link\FileListCacheLink $cache
	 * @param string                            $file
	 *
	 * @return array
	 */
	static public function compile(/** @noinspection PhpUnusedParameterInspection */ FileListCacheLink $cache, $file)
	{
		$compiler = new self();
