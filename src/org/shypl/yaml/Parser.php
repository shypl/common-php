...
class Parser
{
	 ...
	 */
	public function __construct($encoding = 'UTF-8', $documentClass = 'org\shypl\yaml\Document')
	{
	 ...
	 * @param int    $length
	 *
	 * @throws \org\shypl\yaml\ParserException
	 * @return Document[]
	 */
	...
	protected function _analyseMarks($offset, $length)
	{
		...
		/**
		 * @var $doc \org\shypl\yaml\Document
		 */
		$doc = null;
