...
use org\shypl\common\yaml\directive;
use org\shypl\common\yaml\node\Mapping;
use org\shypl\common\yaml\node\Node;
use org\shypl\common\yaml\node\Scalar;
use org\shypl\common\yaml\node\Sequence;
...
class Document
{
	 ...
	 *
	 * @return \org\shypl\common\yaml\Document
	 */
	...
	/**
	 * @param \org\shypl\common\yaml\Document $document
	 * @param mixed              $data
	 *
	 * @return \org\shypl\common\yaml\node\Node
	 */
	...
	/**
	 * @var \org\shypl\common\yaml\directive\Yaml
	 */
	...
	/**
	 * @var \org\shypl\common\yaml\directive\Tag[]
	 */
	protected $_tagDirectives = array();

	/**
	 * @var \org\shypl\common\yaml\directive\Reserved[]
	 */
	protected $_reservedDirectives = array();

	/**
	 * @var \org\shypl\common\yaml\node\Node
	 */
	protected $_rootNode;
	...
	/**
	 * @param \org\shypl\common\yaml\directive\Reserved $directive
	 *
	 ...
	 * @param int $index
	 *
	 * @return \org\shypl\common\yaml\directive\Reserved
	 */
